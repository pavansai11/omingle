...
export function buildRtcConfig(turnIceServers = []) {
  return {
    iceServers: [...STUN_SERVERS, ...turnIceServers],
...
export const MAX_INTEREST_KEYWORDS = 5;
export const TURN_CREDENTIALS_ENDPOINT = '/api/turn-credentials';
